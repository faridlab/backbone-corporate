//! Specifications for TermsAndConditions aggregate
//!
...
// Each predicate implements `Specification<TermsAndConditions>` and can be combined
...
//
// pub struct ActiveTermsAndConditionsSpec;
// impl Specification<TermsAndConditions> for ActiveTermsAndConditionsSpec {
//     fn is_satisfied_by(&self, e: &TermsAndConditions) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
