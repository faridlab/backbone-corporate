...
--
-- This file contains initial seed data for the corporate.territories table.
-- Customize this file to add your initial data.

-- INSERT INTO corporate.territories (
--     id,
--     code,
--     name,
--     parent_id,
...
-- INSERT INTO corporate.territories (id, code, name, is_active, created_at, updated_at) VALUES
