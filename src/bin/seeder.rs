//! Database seeder binary for module: corporate
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Run with: cargo run --bin corporate-seeder
//! Or via CLI: backbone seed run --module corporate
//!
...
use backbone_corporate::seeders::Seeder;
...
async fn main() -> Result<()> {
    ...
    println!();
    println!("Running seeders for module: corporate");
    println!();

    // Register seeders in order
    let mut seeders: Vec<Box<dyn Seeder + Send + Sync>> = Vec::new();
    seeders.push(Box::new(SeedCurrencySeeder::new()));
    seeders.push(Box::new(SeedCurrencyExchangeSeeder::new()));
    seeders.push(Box::new(SeedIncotermSeeder::new()));
    seeders.push(Box::new(SeedTermsAndConditionsSeeder::new()));
    seeders.push(Box::new(SeedTerritorySeeder::new()));
