//! Specifications for CurrencyExchange aggregate
//!
...
// Each predicate implements `Specification<CurrencyExchange>` and can be combined
...
//
// pub struct ActiveCurrencyExchangeSpec;
// impl Specification<CurrencyExchange> for ActiveCurrencyExchangeSpec {
//     fn is_satisfied_by(&self, e: &CurrencyExchange) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
