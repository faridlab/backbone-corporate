//! Specifications for Territory aggregate
//!
...
// Each predicate implements `Specification<Territory>` and can be combined
...
//
// pub struct ActiveTerritorySpec;
// impl Specification<Territory> for ActiveTerritorySpec {
//     fn is_satisfied_by(&self, e: &Territory) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
