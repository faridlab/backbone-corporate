//! Specifications for Incoterm aggregate
//!
...
// Each predicate implements `Specification<Incoterm>` and can be combined
...
//
// pub struct ActiveIncotermSpec;
// impl Specification<Incoterm> for ActiveIncotermSpec {
//     fn is_satisfied_by(&self, e: &Incoterm) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
