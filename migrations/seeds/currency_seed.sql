...
--
-- This file contains initial seed data for the corporate.currencies table.
-- Customize this file to add your initial data.

-- INSERT INTO corporate.currencies (
--     id,
--     iso_code,
--     name,
--     symbol,
...
-- INSERT INTO corporate.currencies (id, code, name, is_active, created_at, updated_at) VALUES
