...
impl CorporateModule {
    ...
    pub fn readonly_routes(&self) -> Router {
        ...
        Router::new()
            ...
            .merge(create_currency_exchange_read_routes(self.currency_exchange_service.clone()))
            .merge(create_incoterm_read_routes(self.incoterm_service.clone()))
            .merge(create_terms_and_conditions_read_routes(self.terms_and_conditions_service.clone()))
