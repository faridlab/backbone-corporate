//! Specifications for Currency aggregate
//!
...
// Each predicate implements `Specification<Currency>` and can be combined
...
//
// pub struct ActiveCurrencySpec;
// impl Specification<Currency> for ActiveCurrencySpec {
//     fn is_satisfied_by(&self, e: &Currency) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
